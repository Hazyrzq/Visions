...
const BASE = 'http://basic-8.alstore.space:23998';
...
export const getRekomendasi = (id) => req(`/rekomendasi/${id}`, { method: 'POST' });
export const getAnalisis = (id) => req(`/analisis/${id}`, { method: 'POST' });
...
export const sendChat = (message, customer_id = null) =>
  req('/chat', {
    method: 'POST',
    body: JSON.stringify({ message, ...(customer_id ? { customer_id } : {}) }),
  });
